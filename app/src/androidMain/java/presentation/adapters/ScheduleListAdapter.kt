...
class ScheduleListAdapter(private val sessions: List<Session>, private val action: IOnUserSessionAction): RecyclerView.Adapter<ScheduleListAdapter.SessionViewHolder>() {
