...
class TabFragment : Fragment(), ISpeakersData, IScheduleData {
    ...
    private fun setup() {
        ...
        val arg1 = Bundle()
        arg1.putString(EXTRA_TAB_TITLE, "09 ${getMonthNameShort(9, Calendar.SEPTEMBER)}")
        arg1.putString(EXTRA_SCHEDULE_DAY, "2019-09-09T00:00:00")
        ...
        val arg2 = Bundle()
        arg2.putString(EXTRA_TAB_TITLE, "10 ${getMonthNameShort(10, Calendar.SEPTEMBER)}")
        arg2.putString(EXTRA_SCHEDULE_DAY, "2019-09-10T00:00:00")
